...
const PasswordInput = ({ label, value, className = '' }) => {
    ...
    <div className="flex flex-col items-start w-full">
      ...
      <div className="flex flex-wrap gap-10 self-stretch py-2 pr-1.5 pl-3 mt-3 w-full bg-white rounded-xl border border-solid shadow-sm border-slate-300">
        ...
        <div className="flex gap-3.5 items-center pr-4 rounded-none">
          ...
          >
            <img
              src={showPassword ? "https://cdn.builder.io/api/v1/image/assets/TEMP/19478e244cda57bad6800eb9b02531459d6f82d3?placeholderIfAbsent=true&apiKey=c7e2682b052c4c1083ff0177ef8c30b4" : "https://cdn.builder.io/api/v1/image/assets/TEMP/0e0af9d04fd9bdf243092a4ae958da81808810d6?placeholderIfAbsent=true&apiKey=c7e2682b052c4c1083ff0177ef8c30b4"}
